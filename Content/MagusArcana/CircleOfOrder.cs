...
{
    internal static class CircleOfOrder
    {
        ...
        public static void Create()
        {
            ...
            circle_buff.m_Icon = DB.GetAbility("Shield of Law").Icon;
            circle_buff.CreateACBonusAgainstAlignment(AlignmentComponent.Chaotic, 0, ModifierDescriptor.Dodge, ContextValueType.Rank);
            circle_buff.CreateContextRankConfigClassLevel(AbilityRankType.Default, DB.GetClass("Magus Class"), ContextRankProgression.Div2);
            ...
            circle_ability.m_Icon = DB.GetAbility("Shield of Law").Icon;
            circle_ability.SetSupernaturalSelf();
            circle_ability.CreateAbilityResourceLogic(DB.GetAbilityResource("Magus Arcane Pool"), 1);
            ...
            circle_feature = Helpers.CreateFeature(
                ...
                null, DB.GetAbility("Shield of Law").Icon);
            circle_feature.HideInCharacterSheetAndLevelUp = true;
            circle_feature.CreateAddFacts(circle_ability);
            circle_feature.CreateClassLevelRestriction(DB.GetClass("Magus Class"), 9);
